...
fn main() {
    ...
    let mut temperature_controller: Box<dyn temperature_controller::HandleTemperature> = Box::new(temperature_controller::TemperatureController::build(temperature_sensor, temperature_modifier, config_reader));
    loop {
